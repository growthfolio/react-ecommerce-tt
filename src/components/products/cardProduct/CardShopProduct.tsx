...
function CardShopProduct({ product }: CardShopProductProps) {
  return (
    <>
      <div className="grid grid-row-3 gap-4  rounded-[15px] bg-pureSnow px-3 py-2">
        <div>
        ...
        <div className="grid gap-1">
          <p className=" fontProdutoNameCard text-[16px] text-charcoalGray capitalize my-1">
            {product.name}
          </p>
          <div className="">
            <hr />
          </div>
          <div className="flex justify-between fontProdutoNameCard text-[15px] text-charcoalGray">
